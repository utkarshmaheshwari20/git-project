            ...
            <div class="row">
              ...
              <div class="form-group col-sm-5">
                ...
                <div class="input-group expiration-date">
                  <input type="text" class="form-control" style="width:80px" placeholder="MM" aria-label="MM" aria-describedby="basic-addon1">
                  <input type="text" class="form-control" style="width:80px" placeholder="YY" aria-label="YY" aria-describedby="basic-addon1">
                </div>
              </div>
